...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="row mt-4">
              <!-- <h4>welcome to hospital dashboard</h4> -->
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">Total report categories</p>
                <?php
                  $i = $_SESSION['auth_user']['userid'];
                  $count = "select * from reportcat where hospital_id= '$i'";
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <?php
                  $i = $_SESSION['auth_user']['userid'];
                  $count = "select * from reports where hospital_id= '$i'";
                  $count_query = mysqli_query($con, $count);
                  $x = mysqli_num_rows($count_query);
                ?>
                <h4 class="mb-0"><?= $x ?></h4>
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <?php
                  $i = $_SESSION['auth_user']['userid'];
                  $count = "select * from claims where hospital_id= '$i'";
                  $count_query = mysqli_query($con, $count);
                  $x = mysqli_num_rows($count_query);
                ?>
                <h4 class="mb-0"><?= $x ?></h4>
