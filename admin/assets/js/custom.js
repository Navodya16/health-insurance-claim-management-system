$(document).ready(function() {
    ...
    $('.delete_insurance_btn').click(function(e) {
        e.preventDefault();
            ...
            .then((willDelete) => {
                if (willDelete) {
                    $.ajax({
                        ...
                        data: {
                            'insurance_id': id,
                            'delete_insurance_btn': true
                        },
                        success: function(response) {
                            if (response == 200) {
                                swal("Success!", "Insurance Company deleted successfully!", "success");
                                $("#insurance_table").load(location.href + " #insurance_table"); //reload the page after deletion
                            } else if (response == 500) {
                                swal("Error!", "Something went wrong!", "error");
                            }
                        }
